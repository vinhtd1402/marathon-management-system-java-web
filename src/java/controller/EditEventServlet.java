...
public class EditEventServlet extends HttpServlet {
    ...
    if (session == null || session.getAttribute("account") == null) {
        ...
        return;
         ...
         MarathonEvent event=DAO.getEventById(id);
        ...
        RequestDispatcher rd= request.getRequestDispatcher("views/admin/EditEvent.jsp");
    ...
    MarathonEvent event = new MarathonEvent(idEvent, name, location, startDate, fee, imagePath, description, healthRequirement, sponsor, type);
    MarathonEventDAO dao = new MarathonEventDAO();
